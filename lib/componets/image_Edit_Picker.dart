...
class ImageEditPicker extends StatefulWidget {
  List imageUrl;
   ImageEditPicker( this.imageUrl,{super.key});

  @override
  State<ImageEditPicker> createState() => _ImageEditPickerState();
}

class _ImageEditPickerState extends State<ImageEditPicker> {
  @override
                    ...
                    child: ReorderableListView.builder(
                      ...
                      onReorder: (oldIndex, newIndex) {
                        setState(() {
                          ...
                          final item =  widget.imageUrl.removeAt(oldIndex);
                         widget.imageUrl.insert(newIndex, item);
                        });
                      },
